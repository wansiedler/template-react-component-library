...
export const SquidGameResult = ({ story, ...props }) => {
                  ...
                  <div className="question-container">
                        ...
                        >
                              <div className="question-main-text">
                                    <div>
                                          {/*<p className="answer-text">{story.subquestion}</p>*/}
                                          <p className="answer-text">Du bist {winner.name}!</p>
                                          {/*<p className="answer-subquestion">{story.subtext2}</p>*/}
                                          <p className="answer-subquestion">{winner.text}</p>
                                    </div>
                              </div>
                        </div>
                  </div>
