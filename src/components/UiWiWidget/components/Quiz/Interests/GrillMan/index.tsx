...
export const GrillMan = ({ data, idx, threshold = 10 }: GrillManProps) => {
      return (
            <div className="result-column">
                  ...
                  <div className="result-topic">{data.topic}</div>
                  <div className="answer-counter answer-details">
                        {data.value > 0 ? data.value / 50 : data.value} von 2
                  </div>
                  <div className="answer-details">Antworten</div>
                  <div className="answer-details">Richtig</div>
            </div>
      );
};
